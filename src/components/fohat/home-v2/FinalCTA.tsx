...
function MagneticCTA() {
  return (
    <Magnetic radius={90} strength={0.35}>
      <ContactDialog>
        <button className="group relative inline-flex h-16 items-center gap-3 overflow-hidden rounded-full bg-white px-10 text-base font-bold text-navy shadow-[0_20px_60px_oklch(0.78_0.11_220_/_0.4)] transition-colors hover:bg-cyan">
          Conte sua ideia
