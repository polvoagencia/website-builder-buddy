        ...
        <div className="grid gap-6 lg:grid-cols-12">
          ...
          >
            ...
            <div className="grid gap-6 md:grid-cols-[1fr_140px] md:items-center">
              ...
              <svg viewBox="0 0 140 140" aria-hidden className="hidden md:block">
                ...
                <path d="M40 110 Q70 82 100 110" stroke="oklch(0.46 0.055 253)" strokeWidth="3" fill="none" strokeLinecap="round" />
                <circle cx="70" cy="70" r="60" fill="none" stroke="oklch(0.46 0.055 253 / 0.25)" strokeDasharray="3 5" />
              </svg>
            </div>
          </SectionReveal>
          ...
          >
            ...
            <svg viewBox="0 0 200 80" aria-hidden className="mt-6 h-16 w-full">
              ...
              <text x="40" y="45" fontSize="9" textAnchor="middle" fill="oklch(0.46 0.055 253)" className="fohat-mono">FERRAMENTA</text>
              ...
              <text x="160" y="45" fontSize="9" textAnchor="middle" fill="oklch(0.22 0.023 250)" className="fohat-mono">INTENÇÃO</text>
            </svg>
          </SectionReveal>
          ...
          >
            ...
            <svg viewBox="0 0 220 120" aria-hidden className="mt-6 h-24 w-full">
              ...
              <text x="70" y="115" fontSize="9" textAnchor="middle" className="fohat-mono" fill="oklch(0.46 0.055 253)">FÍSICO</text>
              <text x="110" y="115" fontSize="9" textAnchor="middle" className="fohat-mono" fill="oklch(0.46 0.055 253)">DIGITAL</text>
              <text x="150" y="115" fontSize="9" textAnchor="middle" className="fohat-mono" fill="oklch(0.46 0.055 253)">HUMANO</text>
            </svg>
          </SectionReveal>
          ...
          >
            ...
            <svg viewBox="0 0 320 120" aria-hidden className="mt-6 h-24 w-full">
              {[
                [30, 60], [90, 30], [90, 90], [160, 60], [230, 30], [230, 90], [290, 60],
              ].map(([x, y], i) => (
                <circle key={i} cx={x} cy={y} r="6" fill="oklch(0.46 0.055 253)" />
              ))}
              {[
                [30, 60, 90, 30], [30, 60, 90, 90], [90, 30, 160, 60], [90, 90, 160, 60],
                [160, 60, 230, 30], [160, 60, 230, 90], [230, 30, 290, 60], [230, 90, 290, 60],
              ].map(([x1, y1, x2, y2], i) => (
                <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke="oklch(0.46 0.055 253 / 0.5)" strokeWidth="1" />
              ))}
            </svg>
          </SectionReveal>
          ...
          >
            ...
            <div className="relative grid gap-6 md:grid-cols-[1fr_auto] md:items-end">
              <div>
                ...
                <p className="mt-4 max-w-2xl text-[oklch(0.85_0.02_250)]">
                  {p5.desc}
                </p>
              </div>
