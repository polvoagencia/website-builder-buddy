    ...
    >
      ...
      <div className="fohat-shell relative">
        <Reveal className="max-w-[880px]">
          ...
          <h2 className="fohat-h2 mt-5">Mais do que entregar equipamentos</h2>
        </Reveal>
          ...
          <Reveal className="relative rounded-3xl border border-navy/15 bg-navy p-8 text-white sm:p-10">
            ...
            <div className="relative">
              ...
              <div className="fohat-mono mt-6 flex flex-wrap items-center gap-2 text-[11px] uppercase tracking-[0.18em] text-cyan/80">
                <span className="rounded-full border border-cyan/40 px-3 py-1">Hardware</span>
                <span aria-hidden>+</span>
                <span className="rounded-full border border-cyan/40 px-3 py-1">Software</span>
                <span aria-hidden>+</span>
                <span className="rounded-full border border-cyan/40 px-3 py-1">Operação</span>
              </div>
              <p className="mt-6 text-xl font-bold leading-snug tracking-tight text-white sm:text-2xl">
                A FOHAT não apenas entrega equipamentos. Ela entende como eles precisam funcionar
                dentro da operação.
              </p>
              <p className="mt-4 text-sm text-[oklch(0.85_0.02_250)]">
                Cada equipamento é pensado como parte de um sistema: conteúdo, integração, presença
                técnica e logística fazem parte do escopo.
              </p>
            </div>
          </Reveal>
            ...
            {RENTAL_DIFFERENTIALS.map((d, i) => (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-bold tracking-tight text-navy">{d.title}</h3>
