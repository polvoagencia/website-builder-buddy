...
export const Route = createFileRoute("/engenharia-de-presenca/projetos/")({
  head: () => ({
    meta: [
      { title: "Projetos de Engenharia de Presença | FOHAT" },
      {
        name: "description",
        content:
          "Cases em que tecnologia, narrativa, espaço e participação foram integrados para criar experiências no mundo real.",
      },
      { property: "og:title", content: "Projetos de Engenharia de Presença | FOHAT" },
      {
        property: "og:description",
        content:
          "Projetos entregues pela FOHAT em que a Engenharia de Presença saiu do conceito e entrou em funcionamento diante do público.",
      },
