...
export const Route = createFileRoute(
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Engenharia de Presença para Eventos e Espaços | FOHAT" },
      {
    ...
    links: [
      { rel: "canonical", href: "/engenharia-de-presenca/eventos-e-espacos" },
    ],
  }),
  component: Eventos,
});
    ...
    <SubpageShell>
      ...
      <SplitMedia
        ...
        image={{
          ...
          caption: "O espaço se torna parte ativa da narrativa e da participação.",
        }}
        reverse
      />
